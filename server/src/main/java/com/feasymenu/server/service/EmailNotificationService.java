...
public class EmailNotificationService implements NotificationService {
    ...
    public void sendExpirationWarning(String email, String tenantName, String label) {
        ...
        String content = String.format("<h3>Dear %s,</h3>"
                ...
                + "<br><p>Best regards,<br>The FeasyMenu Team</p>", tenantName, label);
    ...
    public void sendPlanDowngradedNotification(String email, String tenantName) {
        ...
        String content = String.format("<h3>Dear %s,</h3>"
                ...
                + "<br><p>Best regards,<br>The FeasyMenu Team</p>", tenantName);
    ...
    public void sendLoyaltyCouponEmail(String email, String tenantName, String couponCode, String prizeLabel) {
        ...
        String content = String.format("<h3>Congratulations!</h3>"
                ...
                + "  %s" + "</div>" + "<p>Don't forget to show this code to the waiter or enter it during checkout.</p>"
                + "<br><p>See you soon at %s!<br>The FeasyMenu Team</p>", tenantName, prizeLabel, couponCode,
                tenantName);
