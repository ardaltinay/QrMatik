...
public class UserService {
    ...
    public List<UserEntity> listForTenant(String tenant) {
        ...
        try { return repository.findByTenant_Code(tenant); } catch (Exception e) { return repository.findAll(); }
    }

    public Optional<UserEntity> getById(String id) {
        try { return repository.findById(UUID.fromString(id)); } catch (Exception e) { return Optional.empty(); }
    }
