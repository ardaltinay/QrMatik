...
/**
 * Central source of truth for pricing used by both public API and billing. Values are sourced from
 * configuration (pricing.*) with sensible defaults.
 */
@Service
                ...
                PricingTierDto.builder()
                    ...
                    .features(
                        List.of(
                            "10 masa",
                            "50 ürün",
                            "QR menü ve temel sipariş",
                            "Renk/Logo özelleştirme"))
                    .build(),
                PricingTierDto.builder()
                    .name("Standart")
                    .monthly(props.getStandardMonthly())
                    ...
                    .features(
                        List.of(
                            ...
                            "500 ürün",
                            "Mutfak & Bar panoları",
                            "Popüler ürünler ve raporlar",
                            "Öncelikli e-posta desteği"))
                    .build(),
                PricingTierDto.builder()
                    .name("Pro")
                    .monthly(props.getProMonthly())
                    .yearly(props.getProYearly())
                    .features(
                        List.of(
                            "Sınırsız masa ve ürün",
                            "Gelişmiş raporlar",
                            "İsteğe bağlı özel alan adı (CNAME)",
                            "Öncelikli destek"))
                    .build()))
        .build();
  }
