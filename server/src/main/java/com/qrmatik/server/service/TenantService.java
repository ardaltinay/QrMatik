...
public class TenantService {
  ...
  public Map<String, Object> getConfig(String codeOrNull, String currentTenantOrNull) {
    ...
    if (resolved == null || resolved.isBlank()) resolved = currentTenantOrNull;
    if (resolved == null) throw new NotFoundException("Tenant not found");
  ...
  public Map<String, Object> updateBranding(
      String tenantCode, String primaryColor, String accentColor, String logoUrl) {
    if (tenantCode == null || tenantCode.isBlank()) throw new BadRequestException("Missing tenant");
    var t =
        repository
