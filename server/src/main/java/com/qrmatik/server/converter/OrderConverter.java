  ...
  public OrderDto toDto(OrderEntity e) {
    ...
    try {
      if (e.getCreatedTime() != null) {
        ...
        // İstemciye UTC doğru anı yansıtmak için önce sistem zone'a yerleştirip sonra UTC'ye
        // çeviriyoruz.
        var local = e.getCreatedTime();
        var appZone = ZoneId.systemDefault();
        var utcInstant =
            local.atZone(appZone).withZoneSameInstant(ZoneOffset.UTC).toOffsetDateTime();
