...
public class TenantConverter {
    public TenantDto toDto(TenantEntity e) {
        ...
        return TenantDto.builder().id(e.getId() != null ? e.getId().toString() : null).code(e.getCode())
                ...
                .primaryColor(e.getPrimaryColor()).accentColor(e.getAccentColor()).config(e.getConfigJson())
                .plan(e.getPlan() != null ? e.getPlan().name() : null).customDomain(e.getCustomDomain()).build();
    }
