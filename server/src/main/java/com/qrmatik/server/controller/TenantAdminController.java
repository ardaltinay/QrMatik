...
public class TenantAdminController {
  ...
  public ResponseEntity<TenantDto> update(
      @PathVariable String id, @RequestBody TenantInsertRequest req) {
  ...
  public ResponseEntity<?> bootstrapUsers(
      @PathVariable String code, @RequestBody TenantBootstrapUsersRequest req) {
