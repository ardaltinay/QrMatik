    ...
    if (userRepository.count() == 0) {
      ...
      userRepository.save(
          UserEntity.builder()
              ...
              .tenant(t)
              .passwordHash(pe.encode("kitchen123"))
              .build());
      userRepository.save(
          UserEntity.builder()
              .username("bar")
      ...
      userRepository.save(
          UserEntity.builder()
              ...
              .role(UserRole.STAFF)
              .tenant(t)
              .passwordHash(pe.encode("test123"))
              .build());
      userRepository.save(
          UserEntity.builder()
              .username("super")
              ...
              .tenant(t)
              .passwordHash(pe.encode("super123"))
              .build());
    }
    ...
    if (menuRepository.count() == 0) {
      ...
      menuRepository.save(
          MenuItemEntity.builder()
              ...
              .category("food")
              .subcategory("pizza")
              .image("https://picsum.photos/seed/2/400/240")
              .tenant(tenant)
              .build());
      menuRepository.save(
          MenuItemEntity.builder()
              ...
              .category("food")
              .subcategory("salad")
              .image("https://picsum.photos/seed/3/400/240")
              .tenant(tenant)
              .build());
      menuRepository.save(
          MenuItemEntity.builder()
      ...
      menuRepository.save(
          MenuItemEntity.builder()
              ...
              .category("food")
              .subcategory("dessert")
              .image("https://picsum.photos/seed/6/400/240")
              .tenant(tenant)
              .build());
    }
