...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiError> handlePlanFeature(
      PlanFeatureUnavailableException ex, WebRequest req) {
  ...
  public ResponseEntity<ApiError> handleTableUnavailable(
      TableUnavailableException ex, WebRequest req) {
  ...
  private ResponseEntity<ApiError> build(
      HttpStatus status, String message, String code, WebRequest req, List<String> details) {
    ApiError body =
        new ApiError(
            OffsetDateTime.now(),
            status.value(),
