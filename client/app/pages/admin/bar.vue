  ...
  <div class="p-4 md:p-8 max-w-[1800px] mx-auto h-[calc(100vh-64px)] sm:h-screen overflow-hidden flex flex-col space-y-8">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 shrink-0 bg-white/80 backdrop-blur-2xl p-8 rounded-[3rem] border border-white shadow-2xl shadow-slate-200/40">
      <div class="flex items-center gap-6">
        ...
        <div>
          <h1 class="text-3xl font-black text-slate-900 tracking-tight leading-none mb-2 uppercase">{{ $t('admin.bar.title') }}</h1>
          <div class="flex items-center gap-2">
            <span class="w-2 h-2 rounded-full bg-indigo-500 animate-pulse"></span>
            <p class="text-slate-500 font-bold text-xs uppercase tracking-widest">{{ $t('admin.bar.subtitle') }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full min-w-[360px] max-w-[480px] shrink-0 flex flex-col h-full max-h-full">
        ...
        <div class="flex-grow overflow-y-auto space-y-6 pr-2 scrollbar-thin">
          <TransitionGroup name="list">
            ...
            >
              <div class="absolute top-0 left-0 w-2 h-full bg-indigo-400"></div>
              
              <div class="space-y-6">
                <div class="flex justify-between items-start gap-4">
                  <div class="flex-1 min-w-0">
                    <span class="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] block mb-2">{{ $t('admin.products.barOrder') }}</span>
          ...
          <TransitionGroup name="list">
            ...
            >
              ...
              <div class="space-y-6">
                ...
                <button @click="updateStatus(order.id, 'ready')" class="w-full py-5 bg-indigo-600 text-white font-black text-xs uppercase tracking-[0.2em] rounded-[1.5rem] hover:bg-indigo-700 active:scale-95 transition-all shadow-2xl shadow-indigo-500/20">
