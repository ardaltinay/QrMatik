  ...
  <div>
    <div class="mb-4">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <h2 class="text-xl font-semibold">Bar - Gelen İçecek Siparişleri</h2>
    ...
    <div v-if="filtered.length">
      <div class="grid gap-3">
        <OrderTicket v-for="o in filtered" :key="o.id" :order="o" department="bar" @updateStatus="updateStatus" />
      </div>
    </div>
    <div v-else>
