<template>
  <div>
    ...
    <div v-if="isFreePlan" class="rounded-lg border bg-white p-8 text-center shadow-sm">
      <div class="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-500">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M12 1.5a5.25 5.25 0 00-5.25 5.25v2.25H6a3 3 0 00-3 3v6A3 3 0 006 21h12a3 3 0 003-3v-6a3 3 0 00-3-3h-.75V6.75A5.25 5.25 0 0012 1.5zm3.75 6.75V6.75a3.75 3.75 0 10-7.5 0v1.5h7.5z" clip-rule="evenodd"/></svg>
      </div>
      <p class="mb-4 text-sm text-gray-700">Raporlar sekmesi Standart/Pro yıllık planlarda mevcuttur.</p>
