<template>
  <div>
    <div class="mb-3 grid grid-cols-1 items-start gap-2 sm:grid-cols-3">
      <input
        v-model="q"
        placeholder="Ara: sipariş no veya masa"
        class="focus:ring-brand-200 col-span-2 w-full rounded-lg border p-3 shadow-sm focus:ring-2"
      />
    ...
    <div class="mb-3 md:hidden">
      <h3 class="mb-2 font-semibold">Hızlı Filtreler</h3>
    ...
    <div class="mb-3 hidden md:block">
      <div class="flex flex-wrap items-center gap-2">
        <span class="mr-2 text-sm font-medium">Hızlı Filtreler:</span>
        <button
          @click="setFilter('new')"
          :class="
    ...
    <div v-if="totalPages > 1" class="mt-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        <button class="rounded border px-3 py-1" :disabled="page === 1" @click="prevPage">
          Önceki
        </button>
        <div class="flex gap-1">
          <button
            ...
            :class="
              ...
              (p === page ? 'border-brand-500 bg-brand-500 text-white' : 'bg-white text-gray-700')
            "
          >
            {{ p }}
          </button>
        </div>
        <button class="rounded border px-3 py-1" :disabled="page === totalPages" @click="nextPage">
          Sonraki
        </button>
      </div>
    </div>
