    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <section class="rounded-lg border bg-white p-4 shadow">
        ...
        <label class="block">
          ...
          <input
            ...
            :class="[
              ...
              !isPaidPlan ? 'cursor-not-allowed bg-gray-50 text-gray-500' : '',
            ]"
            placeholder="https://..."
          />
        ...
        <div class="mt-3 flex justify-end">
          <router-link v-if="!isPaidPlan" to="/admin/upgrade" class="btn btn-primary"
            >Planı Yükselt</router-link
          >
        </div>
      </section>
    </div>
    ...
    try {
      const res = await fetchJson("/api/tenant/branding", {
        ...
        body: JSON.stringify({
          ...
          logoUrl: isPaidPlan.value ? logoUrl.value : undefined,
        }),
      });
