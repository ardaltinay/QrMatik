        ...
        <div>
          ...
          <div class="flex gap-3">
            <router-link
              v-if="!showMyOrders"
              to="/menu"
              class="flex-1 min-w-0 text-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-indigo-600 text-white rounded-md shadow hover:bg-indigo-700"
            ...
            <router-link
              v-if="isAdmin"
              to="/admin"
              class="flex-1 min-w-0 text-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-md hover:bg-gray-50"
  ...
  export default {
    ...
    setup() {
      ...
      function readOrderSession() {
        try {
          orderSession.value = localStorage.getItem("qm_order_session");
        } catch {
