  ...
  const features = [
    {
      ...
      icon: makeIcon([{ d: "M5 12h14" }, { d: "M7 4h10" }, { d: "M9 8v8" }, { d: "M15 8v6" }]),
    },
    {
      title: "Sipariş Takibi & İptal",
      desc: "Hazırlanıyor → Hazır → Servis akışını anlık takip edin, gerekirse iptal edin.",
      icon: makeIcon([{ d: "M9 12l2 2 4-4" }, { tag: "circle", cx: "12", cy: "12", r: "9" }]),
    },
    {
    ...
    },
    {
      ...
      icon: makeIcon([{ d: "M4 3h16" }, { d: "M9 7v13" }, { d: "M15 7v13" }, { d: "M4 7h16" }]),
    },
    {
