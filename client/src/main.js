...
async function loadTenantConfig() {
	const tenant = detectTenant() || (() => { try { return localStorage.getItem('qm_tenant') } catch { return null } })()
	if (tenant) {
...
try { const table = detectTableCode(); if (table) localStorage.setItem('qm_table_code', table) } catch { /* ignore */ }
